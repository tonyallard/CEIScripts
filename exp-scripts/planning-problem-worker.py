...
PLAN_FILE_HANDLERS = {
	...
	"Colin-TRH-Colin_TotalEdgesInConflict" : colinPlanFileHandler,
	"Colin-TRH-Colin_TotalEdgesInConflict_NoET" : colinPlanFileHandler,
	"Colin-TRH-Colin_AccumulativeRelax" : colinPlanFileHandler,
	"Colin-TRH-Colin_AccumulativeRelax_NoET" : colinPlanFileHandler,
	...
	"Popf-TRH-Popf_TotalEdgesInConflict" : colinPlanFileHandler,
	"Popf-TRH-Popf_TotalEdgesInConflict_NoET" : colinPlanFileHandler,
	"Popf-TRH-Popf_AccumulativeRelax" : colinPlanFileHandler,
	"Popf-TRH-Popf_AccumulativeRelax_NoET" : colinPlanFileHandler,
	...
	"tplanS8T0" : colinPlanFileHandler,
	"tplanS8T1" : colinPlanFileHandler,
	"tplanS9T0" : colinPlanFileHandler,
	"tplanS9T1" : colinPlanFileHandler,
	"tplanS10T0" : colinPlanFileHandler,
	"tplanS10T1" : colinPlanFileHandler,
	"tplanS11T0" : colinPlanFileHandler,
	"tplanS11T1" : colinPlanFileHandler,
	"tplanS12T0" : colinPlanFileHandler,
	"tplanS12T1" : colinPlanFileHandler,
	"tplanS13T0" : colinPlanFileHandler,
	"tplanS13T1" : colinPlanFileHandler,
	"tplanS14T0" : colinPlanFileHandler,
	"tplanS14T1" : colinPlanFileHandler,
	"tplanS15T0" : colinPlanFileHandler,
	"tplanS15T1" : colinPlanFileHandler,
	"tplanS16T0" : colinPlanFileHandler,
	"tplanS16T1" : colinPlanFileHandler,
	"tplanS17T0" : colinPlanFileHandler,
	"tplanS17T1" : colinPlanFileHandler,
	"tplanS18T0" : colinPlanFileHandler,
	"tplanS18T1" : colinPlanFileHandler,
	"tplanS19T0" : colinPlanFileHandler,
	"tplanS19T1" : colinPlanFileHandler,
