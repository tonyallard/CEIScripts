...
#Author: Tony Allard
#Date: 14 May 2014
#Description: A Python script for running experiments on the VHPOP Planner
...
SYS_LOG_FILE_NAME = NOW + "_VHPOP_SYS_LOG.log"
EXP_LOG_FILE_NAME = NOW + "_VHPOP_EXP_LOG.csv"
OUTPUT_LOC = ROOT_FOLDER + "/exp-output/vhpop"
SYS_LOG_FILE_LOC = OUTPUT_LOC + "/" + SYS_LOG_FILE_NAME
EXP_LOG_FILE_LOC = OUTPUT_LOC + "/" + EXP_LOG_FILE_NAME

#Location of input files
PDDL_FILE_LOC = ROOT_FOLDER + "/PDDL/5-No-Fluents-Or-TILs"
DOMAIN_FILE= PDDL_FILE_LOC + "/LogisticsDomain.pddl"

#Location of Planner
PLANNER_LOC = ROOT_FOLDER + "/Planners/vhpop-2.2.1"
PLANNER = PLANNER_LOC + "/vhpop"
