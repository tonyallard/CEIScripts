...
#Author: Tony Allard
#Date: 14 May 2014
#Description: A Python script for running experiments on the CPT Planner
...
SYS_LOG_FILE_NAME = NOW + "_CPT_SYS_LOG.log"
EXP_LOG_FILE_NAME = NOW + "_CPT_EXP_LOG.csv"
OUTPUT_LOC = ROOT_FOLDER + "/exp-output/CPT"
...
#Location of Planner
PLANNER_LOC = ROOT_FOLDER + "/Planners/CPT"
PLANNER = PLANNER_LOC + "/cpt-1.0"
...
def runProblemTest(planner, domain, problem, problemName, iterations):
	...
	call_arguments = """[
        '%s',
        '%s', '%s', '%s', '%s'], # pass additional parameters by adding elements to this list
        stdout=stdout,
        stderr=stderr
