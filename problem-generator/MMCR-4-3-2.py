...
def main(args):
	...
	for p in range(0, numProblems):
		...
		sectors, locations, connectivityMap, pddl = MMCRProbGen.createSectors(4, 3, capacityRange)

		#Create 2 Vehicles per sector
		vehicles, pddl2 = MMCRProbGen.createVehicles(sectors, 2, connectivityMap, capacityRange, DEFAULT_TRAVEL_TIME, DEFAULT_LOAD_TIME, DEFAULT_UNLOAD_TIME, DEFAULT_COST)
		pddl+=pddl2
